...
import { idlFactory } from './icp_simple_site.did.js';
export { idlFactory } from './icp_simple_site.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_SIMPLE_SITE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_simple_site.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_simple_site canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_simple_site.did.js")._SERVICE>}
 */
export const icp_simple_site = createActor(canisterId);
